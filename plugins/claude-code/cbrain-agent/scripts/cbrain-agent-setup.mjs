...
function parseArgs(values){const result={};for(let i=0;i<values.length;i++){if(values[i]==="--gateway-url")result.gatewayUrl=values[++i];else if(values[i]==="--api-key")result.apiKey=values[++i]}return result}
