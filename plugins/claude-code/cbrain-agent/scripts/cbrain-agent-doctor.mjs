...
try{
  ...
  console.log(result.status==="bound"?`Cbrain Agent: configured, reachable; central binding ${result.team_id}/${result.agent_id}`:"Cbrain Agent: configured, reachable; workspace is unbound and will ask for Team/Agent on the first Claude Code prompt");
