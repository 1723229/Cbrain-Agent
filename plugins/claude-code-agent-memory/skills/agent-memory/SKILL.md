---
name: agent-memory
description: Use Hiper Agent Memory, Wiki/RAG, and CodeGraph through the model-independent gateway.
---

# Hiper Agent Memory

Use the `hiper-agent-memory` MCP server when the task depends on prior project
