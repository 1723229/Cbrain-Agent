...
MEMORY_EMBEDDING_TIMEOUT_MS="${MEMORY_EMBEDDING_TIMEOUT_MS:-3000}"
MEMORY_EMBEDDING_RECALL_TIMEOUT_MS="${MEMORY_EMBEDDING_RECALL_TIMEOUT_MS:-3000}"
MEMORY_EMBEDDING_CAPTURE_TIMEOUT_MS="${MEMORY_EMBEDDING_CAPTURE_TIMEOUT_MS:-10000}"
...
memory:
  ...
  embedding:
    ...
    recallTimeoutMs: ${MEMORY_EMBEDDING_RECALL_TIMEOUT_MS}
    captureTimeoutMs: ${MEMORY_EMBEDDING_CAPTURE_TIMEOUT_MS}
