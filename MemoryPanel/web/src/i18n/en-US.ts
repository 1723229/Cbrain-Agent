...
export const enUS = {
  ...
  // ===== SettingsDialog =====
  'settings.caption': 'System Settings',
  ...
  'settings.tab.permissions': 'Capabilities',
  'settings.tab.zentao': 'ZenTao Sync',
  'settings.zentao.title': 'ZenTao Project and Member Sync',
  'settings.zentao.desc': 'One-way import of ZenTao projects and members. The initial import requires preview and confirmation; later runs occur every five minutes or on demand. Manual Teams and manual membership sources are preserved.',
  'settings.zentao.disabled': 'ZenTao sync is not enabled on the server.',
  'settings.zentao.source': 'Source',
  'settings.zentao.state': 'Status',
  'settings.zentao.lastSuccess': 'Last success',
  'settings.zentao.nextRun': 'Next run',
  'settings.zentao.preview': 'Refresh preview',
  'settings.zentao.initialApply': 'Confirm initial import',
  'settings.zentao.syncNow': 'Sync now',
  'settings.zentao.confirmInitial': 'Create ZenTao Teams and synchronize members from this preview?',
  'settings.zentao.confirmSync': 'Synchronize from this preview now?',
  'settings.zentao.applied': 'Sync complete. Default Agent provisioning: {{success}} succeeded, {{failed}} failed, {{pending}} pending.',
  'settings.zentao.previewSummary': 'Teams: {{create}} create, {{update}} update, {{inactive}} deactivate, {{reactivate}} reactivate. Members: {{add}} add, {{remove}} remove, {{role}} role changes. Unmatched accounts: {{unresolved}}.',
  'team.source.zentao': 'ZenTao synced',
  'team.status.archived': 'Inactive',
  ...
  'error.TEAM_MANAGED_BY_ZENTAO': 'This Team is managed by ZenTao. Update it in ZenTao and synchronize again.',
  'error.MEMBER_MANAGED_BY_ZENTAO': 'This membership is managed by ZenTao and cannot be removed or demoted in Cbrain.',
  'error.PREVIEW_STALE': 'ZenTao data changed after the preview. Refresh the preview before applying.',
  'error.ZENTAO_UNAVAILABLE': 'ZenTao is unavailable. Check the service, credentials, and network, then retry.',
  'error.SYSTEM_ADMIN_REQUIRED': 'This action requires a system administrator.',
  ...
  'guide.cbrain.title': 'Cbrain User Guide',
  'guide.cbrain.subtitle': 'Platform usage and client integration are separated so you can quickly find the right workflow.',
  'guide.platform.title': 'Platform Guide',
  'guide.platform.desc': 'Sign in to Cbrain with LDAP and manage Teams, members, Agents, and shared knowledge assets.',
  ...
  'guide.client.desc': 'Codex and Claude Code keep their model connection and use Cbrain through a separate plugin.',
